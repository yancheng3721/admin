...
$(function() {
	...
	var allFiledsStr = '[{"_CN_":"ID","_KEY_":"ID"},{"_CN_":"类型","_KEY_":"TYPE","_NOT_NULL_":"1"},{"_CN_":"父菜单","_KEY_":"PARENT_ID"},{"_CN_":"菜单（功能）名","_KEY_":"NAME","_NOT_NULL_":"1"},{"_CN_":"功能路径","_KEY_":"URL"},{"_CN_":"更新用户","_KEY_":"UPDATE_USER"},{"_CN_":"创建时间","_KEY_":"CREATE_TIME"},{"_CN_":"更新时间","_KEY_":"UPDATE_TIME"}]';
...
<form method="post" action="" id="searchForm">			
		<div class="mRtBox">
			...
			<div class="rTitle" >
				<h3><i class="title"></i><span id="title">菜单管理</span></h3>
			...
			<div class="searchCenter">
				...
				<table width="100%" class="searTabBg">
					<tr>
<td class='tdName'>菜单（功能）名：</td>
<td style='width:140px;'>
<input name='searchbox.NAME' type='text' id='searchbox.NAME'  value='${searchbox["NAME"]}' />
</td><td class='tdName'>功能路径：</td>
<td style='width:140px;'>
<input name='searchbox.URL' type='text' id='searchbox.URL'  value='${searchbox["URL"]}' />
</td></tr>
			...
			<div class="searchCenter">
				<input type="hidden" name="exportFields" value="PARENT_NAME,NAME,URL"/>
...
<div id="saveDialog" title="菜单保存" style="display:none" >
	<input type="hidden" class="savebox" name="saveboxID" id="saveboxID" >
	<div class="box-content">
	<table style="margin-top:10px;font-size:12px;">
		
		<tr style='height:35px;'> 
<td width='140px' align='right'>父菜单：</td>
...
<tr style='height:35px;'>
<td width='140px' align='right'>菜单（功能）名：</td>
<td> <input type='text' class='savebox'  name='saveboxNAME' id='saveboxNAME' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>功能路径：</td>
<td> <input type='text' class='savebox'  name='saveboxURL' id='saveboxURL' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>类型：</td>
<td> <select style='width:100%;height:22px;' class='savebox'  name='saveboxTYPE' id='saveboxTYPE'>
...
<div class="showBox" id="batchupload" style="display:none;" title="菜单批量上传">
	<form action="/admin/menu/uploadMenu.do" method="POST" id="sguploadForm" name="sguploadForm" enctype="multipart/form-data" onsubmit="return false;">
		<div style="text-align: center;margin: 10px 0;">
			<span>路径：</span>
			<input type="hidden" name="importFields" value="PARENT_ID,NAME,URL,TYPE"/>
