...
$(function() {
	...
	var allFiledsStr = '[{"_CN_":"ID","_KEY_":"ID"},{"_CN_":"展示名称","_KEY_":"SHOW_NAME","_NOT_NULL_":"1"},{"_CN_":"专题描述","_KEY_":"DESCRIPTION","_NOT_NULL_":"1"},{"_CN_":"主站排序值","_KEY_":"SORT","_NOT_NULL_":"1"},{"_CN_":"APP排序值","_KEY_":"APP_SORT","_NOT_NULL_":"1"},{"_CN_":"过滤规则","_KEY_":"FILTER","_NOT_NULL_":"1"},{"_CN_":"专题名","_KEY_":"TOPIC_NAME"},{"_CN_":"专题编码","_KEY_":"TOPIC_CODE","_NOT_NULL_":"1"},{"_CN_":"SEO编码","_KEY_":"SEO_CODE","_NOT_NULL_":"1"},{"_CN_":"更新用户","_KEY_":"UPDATE_USER"},{"_CN_":"创建时间","_KEY_":"CREATE_TIME"},{"_CN_":"更新时间","_KEY_":"UPDATE_TIME"}]';
    ...
    function expand(obj){
    	if(obj.ID){
			$.ajax({
				url: '/admin/feature/expandFeature.do',
				type: 'POST',
				dataType: 'json',
				timeout: 5000,
				data:obj,
	...
	function doBtchDel(){
		...
		$.ajax({
				url: '/admin/feature/batchDeleteFeature.do',
				type: 'POST',
				dataType: 'json',
				timeout: 5000,
				data:{ids:ids},
	...
	function doSave(){
		...
		//alert(222);
		$.ajax({
				url: '/admin/feature/saveFeature.do',
				type: 'post',
				dataType: 'json',
				timeout: 5000,
				data:params,
	...
	function doDelete(obj){
		...
		$.ajax({
				url: '/admin/feature/deleteFeature.do',
				type: 'post',
				dataType: 'json',
				timeout: 5000,
				data:obj,
	...
	function doQuery(){
		...
		searchForm.attr("action","/admin/feature/queryFeature.do");
		searchForm.submit();
	}
	...
	function syncData(){
		...
		$.ajax({
				url: '/admin/feature/syncFeature.do',
				type: 'POST',
				dataType: 'json',
		...
		$('#sguploadForm').ajaxSubmit({
                ...
                success:function(data){
                	...
                	if (data.obj.message == "上传成功!") {
                	   window.location.href="/admin/feature/manageFeature.do";
                	}
                },
                error:function(xhr){
	...
	function exportCsv() {
		var searchForm = $("#searchForm");
		var tmp = searchForm.attr("action");
		searchForm.attr("action","/admin/feature/exportFeature.do");
		searchForm.submit();
...
<form method="post" action="" id="searchForm">			
		<div class="mRtBox">
			...
			<div class="rTitle" >
				<h3><i class="title"></i><span id="title">专题模块管理</span></h3>
			...
			<div class="searchCenter">
				...
				<table width="100%" class="searTabBg">
					<tr>
<td class='tdName'>展示名称：</td>
<td style='width:140px;'>
<input name='searchbox.SHOW_NAME' type='text' id='searchbox.SHOW_NAME'  value='${searchbox["SHOW_NAME"]}' />
</td><td class='tdName'>专题编码：</td>
<td>
	<select style='width:140px;height:22px;' name='searchbox.TOPIC_CODE' id='searchbox.TOPIC_CODE'>
	<option value=''>选择专题编码</option>
	<#if TOPIC_CODESelect??>
<#list TOPIC_CODESelect?keys as key>
<#if searchbox["TOPIC_CODE"] == key >
	<option value='${key}' selected='selected'>${TOPIC_CODESelect[key]}</option>
<#else>
	<option value='${key}'>${TOPIC_CODESelect[key]}</option>
</#if></#list></#if>
	</select>
</td>
<td class='tdName'>SEO编码：</td>
<td style='width:140px;'>
<input name='searchbox.SEO_CODE' type='text' id='searchbox.SEO_CODE'  value='${searchbox["SEO_CODE"]}' />
</td></tr>
			...
			<div class="searchCenter">
				<input type="hidden" name="exportFields" value="SHOW_NAME,DESCRIPTION,SORT,APP_SORT,FILTER,TOPIC_CODE,SEO_CODE"/>
...
<td>${obj.SEO_CODE}</td>
			...
			<div class="searchCenter pagenation" style="text-align:right">
				<script type="text/javascript">
					window.__page=new SnPage(document.getElementById("searchForm"),'/admin/feature/queryFeature.do','${page.totalPage?c}','${page.currentPage?c}');
				</script>
...
<div id="saveDialog" title="专题模块保存" style="display:none" >
	<input type="hidden" class="savebox" name="saveboxID" id="saveboxID" >
	<div class="box-content">
	<table style="margin-top:10px;font-size:12px;">
		
		<tr style='height:35px;'>
<td width='140px' align='right'>展示名称：</td>
<td> <input type='text' class='savebox'  name='saveboxSHOW_NAME' id='saveboxSHOW_NAME' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>专题描述：</td>
<td> <input type='text' class='savebox'  name='saveboxDESCRIPTION' id='saveboxDESCRIPTION' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>主站排序值：</td>
<td> <input type='text' class='savebox'  name='saveboxSORT' id='saveboxSORT' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>APP排序值：</td>
<td> <input type='text' class='savebox'  name='saveboxAPP_SORT' id='saveboxAPP_SORT' ></td>
</tr>
<tr style='height:35px;'> 
<td width='140px' align='right'>过滤规则：</td>
<td><select style='width:100%;' class='savebox'  name='saveboxFILTER' id='saveboxFILTER'>
	<option value=''>选择过滤规则</option>
<#if FILTERSelect??>
<#list FILTERSelect?keys as key>
	<option value='${key}'>${FILTERSelect[key]}</option>
</#list>
</#if>
	</select>
</td>
...
<tr style='height:35px;'> 
<td width='140px' align='right'>专题编码：</td>
<td><select style='width:100%;' class='savebox'  name='saveboxTOPIC_CODE' id='saveboxTOPIC_CODE'>
	<option value=''>选择专题编码</option>
<#if TOPIC_CODESelect??>
<#list TOPIC_CODESelect?keys as key>
	<option value='${key}'>${TOPIC_CODESelect[key]}</option>
...
<tr style='height:35px;'>
<td width='140px' align='right'>SEO编码：</td>
<td> <input type='text' class='savebox'  name='saveboxSEO_CODE' id='saveboxSEO_CODE' ></td>
</tr>
...
<#--批量上传-->
<div class="showBox" id="batchupload" style="display:none;" title="专题模块批量上传">
	<form action="/admin/feature/uploadFeature.do" method="POST" id="sguploadForm" name="sguploadForm" enctype="multipart/form-data" onsubmit="return false;">
		<div style="text-align: center;margin: 10px 0;">
			<span>路径：</span>
			<input type="hidden" name="importFields" value="SHOW_NAME,DESCRIPTION,SORT,APP_SORT,FILTER,TOPIC_CODE,SEO_CODE"/>
	...
	<div align="center">
		<div class="add" >
			...
			<table width="100%" class="up_table" border="1">
				<th>展示名称</th><th>专题描述</th><th>主站排序值</th><th>APP排序值</th><th>过滤规则</th><th>专题编码</th><th>SEO编码</th>
			</table>
			<div class="rTitle" align="left">
				<h3>上传注意事项</h3>
			</div>
