...
$(function() {
	...
	var allFiledsStr = '[{"_CN_":"ID","_KEY_":"ID"},{"_CN_":"用户名","_KEY_":"NAME","_NOT_NULL_":"1"},{"_CN_":"更新用户","_KEY_":"UPDATE_USER"},{"_CN_":"创建时间","_KEY_":"CREATE_TIME"},{"_CN_":"更新时间","_KEY_":"UPDATE_TIME"}]';
...
<form method="post" action="" id="searchForm">			
		<div class="mRtBox">
			...
			<div class="rTitle" >
				<h3><i class="title"></i><span id="title">角色管理管理</span></h3>
...
<div id="saveDialog" title="角色管理保存" style="display:none" >
...
<#--批量上传-->
<div class="showBox" id="batchupload" style="display:none;" title="角色管理批量上传">
