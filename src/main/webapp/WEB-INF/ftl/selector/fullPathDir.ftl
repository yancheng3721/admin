...
if('${_msg}'!=null&&'${_msg}'!=""){
   alert('${_msg}');
	...
	function doQuery(){
		...
		searchForm.attr("action", "/admin/selector/query.do").submit()
	}
	
	$(function() {
		if(window.location.href.indexOf('/admin/selector/query.do')==-1){
...
<form method="post" action="" id="searchForm">			
		<div class="mRtBox">
			...
			<div class="searchCenter" style="text-align:right">
				<script type="text/javascript">
					window.__page=new SnPage(document.getElementById("searchForm"),'/admin/selector/query.do','${page.totalPage?c}','${page.currentPage?c}');
				</script>
