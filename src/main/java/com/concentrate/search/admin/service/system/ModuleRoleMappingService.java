package com.concentrate.search.admin.service.system;
...
import com.concentrate.search.admin.dao.system.ModuleRoleMappingDAO;

@Service
public class ModuleRoleMappingService {

    @Autowired
    private ModuleRoleMappingDAO dao;
